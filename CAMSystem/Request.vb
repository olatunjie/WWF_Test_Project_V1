...
Public Class Request
    ...
    Public Sub SaveRequest(ByVal doctype As String, ByVal reqname As String, ByVal status As String, ByVal origuser As Object, ByVal entrydate As Date, ByVal remark As String, ByVal task_id As String, ByVal action As String, ByVal comment As String, ByVal usingsupervisor As Boolean)
        Try
            Me.ErrorMessage = String.Empty
            Dim storex As New DAL
            Me.Doc_Type = doctype
            ...
            storex.SaveRequest(Me)
            ProcessRequest(task_id, action, Me.Doc_Type, comment, Me.OriginatingUser, usingsupervisor)
        Catch ex As Exception
            storex = New DAL
            storex.SaveErrorMsg(doctype, ex.Message & " - Module:- Request::SaveRequest()")
        End Try
    ...
    Public Sub SaveRequest(ByVal doctype As String, ByVal reqname As String, ByVal status As String, ByVal origuser As Object, ByVal entrydate As Date, ByVal remark As String, ByVal task_id As String, ByVal action As String, ByVal comment As String, ByVal getapprovals As Boolean, ByVal terminalpoint As Boolean)
        Try
            Me.ErrorMessage = String.Empty
            Dim storex As New DAL
            Me.Doc_Type = doctype
            ...
            storex.SaveRequest(Me)
            ProcessRequest(task_id, action, Me.Doc_Type, comment, Me.OriginatingUser, getapprovals, terminalpoint)
        Catch ex As Exception
            storex = New DAL
            storex.SaveErrorMsg(doctype, ex.Message & " - Module:- Request::SaveRequest()")
        End Try
    ...
    Public Function ProcessRequest(ByVal taskID As String, ByVal requestname As String, ByVal doctype As String, ByVal owner As Object, ByVal connectionstr As String, ByVal tablename As String, ByVal fieldnames As String) As Integer
                    ...
                    Else
                        ...
                        If Not (storex.GetCondition(doctype, user_rule) = String.Empty) Then
                            ...
                            For i As Integer = 0 To assignedUsers.Count - 1
                                ...
                                returnVal = task.SaveTask(taskID, owner, assignedUsers(i), action, "Pending", "", DateTime.Now, doctype)
                                'Else
    ...
    Public Function ProcessRequest(ByVal taskID As String, ByVal requestname As String, ByVal doctype As String, ByVal owner As Object) As Integer
        Dim returnVal As Integer = 0
        Try
            Me.ErrorMessage = String.Empty
            Dim result As New ArrayList
    ...
    Public Function ProcessRequest(ByVal taskID As String, ByVal requestname As String, ByVal doctype As String, ByVal comment As String, ByVal owner As Object) As Integer
        Dim returnVal As Integer = 0
        Try
            Me.ErrorMessage = String.Empty
            Dim result As New ArrayList
                ...
                If (result.Count > 0) Then
                    ...
                    Else
                        ...
                        If Not (storex.GetCondition(doctype, user_rule) = String.Empty) Then
                            ...
                            For i As Integer = 0 To assignedUsers.Count - 1
                                returnVal = task.SaveTask(taskID, owner, assignedUsers(i), action, "Pending", comment, DateTime.Now, doctype)
                            Next
    ...
    Public Function ProcessRequest(ByVal taskID As String, ByVal requestname As String, ByVal doctype As String, ByVal comment As String, ByVal owner As Object, ByVal getsupervisor As Boolean) As Integer
        Dim returnVal As Integer = 0
        Try
            Me.ErrorMessage = String.Empty
            Dim result As New ArrayList
            ...
            Else
                ...
                If (result.Count > 0) Then
                    ...
                    Else
                        ...
                        If Not (storex.GetCondition(doctype, user_rule) = String.Empty) Then
                            assignedUsers.Clear()
                            assignedUsers = assuser.GetAssignedUsers(user_rule, owner, doctype, True)
                            ...
                            If (state = "Processing") Then
                                storex.UpdateRequestStatus(owner, "Assigned", requestname, DateTime.Now.Date, doctype)
                            Else
                                Me.SaveRequest(doctype, requestname, "Processing", owner, DateTime.Now.Date, msgaction, taskID, action, comment, getsupervisor)
                            End If
                        End If
                    End If
                End If
    ...
    Public Function ProcessRequest(ByVal taskID As String, ByVal requestname As String, ByVal doctype As String, ByVal comment As String, ByVal owner As Object, ByVal getapprovals As Boolean, ByVal terminalpoint As Boolean) As Integer
        Dim returnVal As Integer = 0
        Try
            Me.ErrorMessage = String.Empty
            Dim result As New ArrayList
            ...
            Else
                ...
                If (result.Count > 0) Then
                    ...
                    Else
                        ...
                        If Not (storex.GetCondition(doctype, user_rule) = String.Empty) Then
                            assignedUsers.Clear()
                            assignedUsers = assuser.GetAssignedUsers(user_rule, owner, doctype, True, True)
                            ...
                            If (state = "Processing") Then
                                storex.UpdateRequestStatus(owner, "Assigned", requestname, DateTime.Now.Date, doctype)
                            Else
                                Me.SaveRequest(doctype, requestname, "Processing", owner, DateTime.Now.Date, msgaction, taskID, action, comment, getapprovals, terminalpoint)
                            End If
                        End If
                    End If
                End If
