Public Class Task
    ...
    Public Sub SaveTask(ByVal taskid As String, ByVal origusr As String, ByVal userid As String, ByVal action As String, ByVal status As String, ByVal message As String, ByVal entrydate As Date, ByVal doctype As String)
        Try
