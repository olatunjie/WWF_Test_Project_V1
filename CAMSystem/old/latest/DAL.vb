...
Public Class DAL
    Private conn As New SqlConnection("Data Source=10.0.0.155;Initial Catalog=WorkFlowDB;User ID=sa;Password=system")
    'Private conn As New SqlConnection("Data Source=HQ-TECH-L27;Initial Catalog=WorkFlowDB;Integrated Security=true")
    ...
    Public Function GetUserProp(ByVal owner As String) As SqlDataReader
        Try
            Dim reader As SqlDataReader
            Dim returnval As String = String.Empty
            If (conn.State = ConnectionState.Closed) Then
