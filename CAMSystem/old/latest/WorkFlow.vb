...
Public Class WorkFlow
    Public Class DAL
        ...
        Public Shared Sub UpdateTaskStatus(ByVal status As String, ByVal taskID As String, ByVal origUser As String, ByVal userID As String, ByVal entdate As Date, ByVal doctype As String, ByVal comments As String)
            Try
                DAL.ErrorMessage = String.Empty
                Dim conn As New SqlConnection(connstr)
                If (conn.State = ConnectionState.Closed) Then
