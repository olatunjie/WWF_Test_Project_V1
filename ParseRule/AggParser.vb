...
Public Class AggParser
    Private stack(100) As String
    Private stack2(100) As String
    Private br_stack(100) As String
    Private br_stack2(100) As String
    Private stack3(100) As String
    Private rules_stack(100) As String
    Private logicalop_stack(100) As String
    Private evaluate_stack(100) As String
    ...
    Dim propsVal As New ArrayList
    Dim propsindex As Integer = 0

    Public Sub New()

    End Sub

    Public Sub Run(ByVal current_rule As String, ByVal propsvalue As ArrayList)
        Try
            Dim rule As String
            propsVal = propsvalue
            rule = current_rule
    ...
    Public Function Parse(ByVal ntype As String, ByVal nvalue As String, ByVal nop As String) As String
        ...
        Try
            ...
            newtype = propsVal.Item(propsindex)
