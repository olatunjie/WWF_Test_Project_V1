...
Public Class RuleParser
    Private stack(200) As String
    Private stack2(200) As String
    Private br_stack(200) As String
    Private br_stack2(200) As String
    Private stack3(200) As String
    Private rules_stack(200) As String
    Private logicalop_stack(200) As String
    Private evaluate_stack(200) As String
