...
Public Class DAL
    ...
    Sub New()
        Try
            conn = New SqlConnection("Data Source=10.0.0.210;Initial Catalog=ORM;User ID=sa;User ID=sa;password=system")
            conn.Open()
    ...
    Public Sub ResetUserProperties2(ByVal owner As String)
        Try
    ...
    Public Sub saveAssignment(ByVal assign As Assignment)
        Try
            ...
            cmd.Parameters.Add("@Request", SqlDbType.NVarChar, 100).Value = assign.Request
            cmd.ExecuteNonQuery()
        Catch ex As Exception
            Me.ErrorMessage = ex.Message
        End Try
